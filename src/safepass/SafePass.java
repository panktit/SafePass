 ...
 * @author Pankti
 */
public class SafePass extends javax.swing.JFrame {
    private final String iconPath = "/ico.png";
    private final String dbPath = "sfpdb.xml";
    private final int passwordCopyTimeoutSec = 30;
    
    private final String progTitle = "SafePass";
    private final String version = "v1.0";
    
    private DataTable dt = null;
    private final String[] rowHeader = {"Website","Login Id","Comment","Creation date"};
    private ImageIcon icon; 
    
    //Creates new form SafePass
    public SafePass() {
        //init main window
        initComponents();
        ...
        //set window icon
        try {
            URL url = SafePass.class.getResource(iconPath);
    ...
    private void newEntry() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Cannot create record",
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(clrButton, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void cmpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmpButtonActionPerformed
        ...
        if(dt.changeMasterPass(kp.oldKey, kp.newKey))
            JOptionPane.showMessageDialog(null, "Master password changed successfully",
                "Info", JOptionPane.INFORMATION_MESSAGE);
        else JOptionPane.showMessageDialog(null, "Error in changing master password",
                "Error", JOptionPane.ERROR_MESSAGE);
        updateTable();
